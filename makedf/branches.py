...
slcbranches = [
    ...
    "rec.slc.nu_score",
    # full SRTPCPMTBarycenterMatch record (header identical v10_00_14/v10_14_02_05)
    "rec.slc.barycenterFM.chargeTotal",
    "rec.slc.barycenterFM.chargeCenterXLocal",
    "rec.slc.barycenterFM.chargeCenter.x", "rec.slc.barycenterFM.chargeCenter.y", "rec.slc.barycenterFM.chargeCenter.z",
    "rec.slc.barycenterFM.chargeWidth.x", "rec.slc.barycenterFM.chargeWidth.y", "rec.slc.barycenterFM.chargeWidth.z",
    ...
    "rec.slc.barycenterFM.flashCenter.x", "rec.slc.barycenterFM.flashCenter.y", "rec.slc.barycenterFM.flashCenter.z",
    "rec.slc.barycenterFM.flashWidth.x", "rec.slc.barycenterFM.flashWidth.y", "rec.slc.barycenterFM.flashWidth.z",
    ...
    "rec.slc.barycenterFM.radius_Trigger",
